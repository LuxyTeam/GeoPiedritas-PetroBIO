...
const quickNavItems = [
    ...
    { id: 'compuestos', icon: 'science', label: 'Compuestos', description: 'Química' },
    { id: 'formacion', icon: 'history_edu', label: 'Formación', description: 'Ciclo sedimentario' },
    { id: 'ambientes', icon: 'terrain', label: 'Ambientes', description: 'Lugar de depósito' },
    { id: 'diagenesis', icon: 'compress', label: 'Diagénesis', description: 'Litificación' },
    { id: 'caracteristicas', icon: 'science', label: 'Características', description: 'Propiedades' },
    { id: 'tipos', icon: 'grid_view', label: 'Tipos', description: 'Clasificación' },
    { id: 'tabla', icon: 'table_chart', label: 'Tabla', description: 'Resumen' },
]
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className={`relative z-10 text-center max-w-7xl mx-auto px-4 sm:px-6 py-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                ...
                <button
                    onClick={onExploreClick}
                    className="absolute bottom-4 left-1/2 transform -translate-x-1/2 opacity-60 animate-bounce cursor-pointer hover:opacity-100 transition-opacity"
